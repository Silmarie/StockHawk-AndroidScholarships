            ...
            while (iterator.hasNext()) {
                ...
                if (stock.getCurrency() == null) {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(context, MessageFormat.format(context.getString(R.string.toast_invalid_quote), symbol), Toast.LENGTH_LONG).show();
                        }
                    });
                    continue;
                }
                ...
                // Due to problems with the Yahoo API we have commented the line above
